...
\name{
  ...
  Mingyang Ni \textsuperscript{a} and Yijia Wang \textsuperscript{a}}\affil{\textsuperscript{a}School of Geography and Planning, Sun Yat-Sen University, Guangzhou, 510275, China; \textsuperscript{b} Guangdong Key Laboratory for Urbanization and Geo-simulation, Guangzhou, 510275, China}
}
...
\begin{figure}
  \centering
  \subfloat[\textit{S. littoreus} was burial after a typhoon.]{%
...
\begin{figure}[!h]
  ...
  \resizebox*{6cm}{!}{\includegraphics{../figs/fig9a.jpg}}}\hspace{5pt}
  \subfloat[Stabilized period.]{%
  \resizebox*{6cm}{!}{\includegraphics{../figs/fig9b.jpg}}}
